...
static const int HIT_QUEUE_SCALAR = HIT_QUEUE_BASE_SIZE - 1;
static const int HIT_QUEUE_FULL_SIZE = HIT_QUEUE_BASE_SIZE * 4;

static const int MUTE_FILTER_SIZE = 24;
static const int MUTE_FILTER_COUNT = 693;
